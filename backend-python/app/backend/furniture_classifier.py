...
def normalize_furniture_type(ftype: str) -> str:
    ...
    aliases = {
        ...
        "coffee_table_round": "coffee_table_round",
        "round_coffee_table": "coffee_table_round",
        ...
        "l_shaped_sofa": "sectional",
        "outdoor_dining_set": "outdoor_dining_set",
        "patio_dining_set": "outdoor_dining_set",
        "office_chair": "office_chair",
        "task_chair": "office_chair",
        "ergonomic_chair": "office_chair",
